...
public class Topic03_XPath_Part_I{
	WebDriver driver;
	...
	//verify (Autual data= expected data)
	...
	public void Register_03_Incorrect_Email() {
		...
		//Action
				driver.findElement(By.id("txtFirstname")).sendKeys("John Wick");
				driver.findElement(By.id("txtEmail")).sendKeys("John@mail.com");
				driver.findElement(By.id("txtCEmail")).sendKeys("John@mail.net");
				driver.findElement(By.id("txtPassword")).sendKeys("123456");
				driver.findElement(By.id("txtCPassword")).sendKeys("123456");
				driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
				driver.findElement(By.xpath("//form[@id='frmLogin']//button[text()='ĐĂNG KÝ']")).click();
				...
				//verify (Autual data= expected data)
				Assert.assertEquals(driver.findElement(By.id("txtCEmail-error")).getText(),"Mật khẩu bạn nhập không khớp");
	}
	...
	public void Register_04_Password_Less_Than_6_Chars() {
		...
		//Action
				driver.findElement(By.id("txtFirstname")).sendKeys("John Wick");
				driver.findElement(By.id("txtEmail")).sendKeys("John@mail.com");
				driver.findElement(By.id("txtCEmail")).sendKeys("John@mail.com");
	...
	@Test
	public void Register_05_Incorrect_confim_Password () {
		driver.get("https://alada.vn/tai-khoan/dang-ky.html");
		//Action
				driver.findElement(By.id("txtFirstname")).sendKeys("John Wick");
				driver.findElement(By.id("txtEmail")).sendKeys("John@mail.com");
